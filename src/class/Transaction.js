...
const { numberToHex, hexToNumber, toWei, fromWei, isHexStrict } = web3.utils;
...
export default class Transaction {
  constructor({
    ...
    this.gasPrice = isHexStrict(gasPrice)
      ? fromWei(gasPrice, 'Gwei')
      : gasLimit;
    this.gasLimit = isHexStrict(gasLimit) ? hexToNumber(gasLimit) : gasLimit;
