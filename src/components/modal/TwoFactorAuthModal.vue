<template lang="html">
  ...
  >
    ...
    <div v-if="secret">
      <p class="lead">
        To protect your account, we strongly recommend enabling two factor
        authentication. Once enabled, you will be able to log in by entering a
        code generated by an authenticator app.
      </p>

      <p class="lead">
        Scan the QR code below into <strong>Google Authenticator</strong>. If
        you are unable to scan the code, you can also enter the secret manually.
      </p>
    </div>
    <v-form
      id="twoFactorAuth"
    ...
    >
      ...
      >
        ...
        <p class="subtitle">
          Write down the recovery secret below:
        </p>
